...
const techStack: ReadonlyArray<string> = [
  'Next.js 16',
  'Tailwind CSS v4',
  'TypeScript',
] as const;
  ...
  <article className="pt-32 pb-24">
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border-primary border-l-4 bg-primary/5 p-6">
    ...
    >
      ...
      <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
        ...
        <a
          ...
          className="inline-flex h-10 items-center justify-center gap-2 rounded-md bg-primary px-6 font-medium text-primary-foreground text-sm transition-colors hover:bg-primary/80"
        >
          Visit Live Platform
