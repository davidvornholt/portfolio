...
export const StudyDecision = (): ReactNode => (
  <MDXSection>
    ...
    <MDXParagraph>
      I will use <MDXStrong>Astra at medium effort for the lead agent and every
      reviewer and repair agent</MDXStrong>. Medium is my chosen balance, not a
      proven optimum. I did not compare Astra's effort settings against each
      other.
    </MDXParagraph>
    <MDXParagraph>
    ...
    <MDXParagraph>
      ...
      review that misses a bug can still return a confident report. There may
      be no warning that I need a stronger review. If I need Astra to check
      whether I can trust the cheap review, I have not replaced Astra.
    </MDXParagraph>
    <MDXParagraph>
      ...
      limits matter. They do not erase the demonstrated bugs, the broken
      repair, or the mixed setup's failure to save money.
    </MDXParagraph>
    <MDXParagraph>
    ...
    <MDXParagraph>
      The optional <MDXAnchor href="/posts/cheap-ai-code-reviews/evidence.md">
        methods and cost notes
      </MDXAnchor> include the accounting and limitations. Unpublished project
      details are omitted, so this is not a fully public replication package.
    </MDXParagraph>
  </MDXSection>
);
